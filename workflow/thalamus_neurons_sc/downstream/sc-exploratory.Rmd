...
for (celltype in names(ncount_list)) {
    ...
    for (counttype in names(ncount_list[[celltype]])) {
        ...
        for (gene in names(ncount_list[[celltype]][[counttype]])) {
            ...
            # Plot
            for (y_var in c('percell_junctions', 'percent_detection')) {
                cat('\n\n###### - Plot:', y_var, '\n\n')
                ...
                # Specify Y-label
                ylabel <- ifelse(y_var == "percent_detection",
                                 "% Cells with Junction Detection",
                                 "Number of Junctions Detected per Cell")
                p <- plot_percell_junctions(ycol=y_var, ylabel=ylabel)
                print(p)
                cat('\n\n')
            }
