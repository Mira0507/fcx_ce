...
in the `SCA` object, as shown below:
...
```{r qc_heatmap, results='asis', fig.height=12, fig.width=12, eval=FALSE}

aheatmap(assay(sca),
         labRow='',
         annCol=as.data.frame(colData(sca)[, names(factor_groups)]))
```

## PCA {.tabset}

```{r qc_pca, results='asis', fig.height=10, fig.width=10}
