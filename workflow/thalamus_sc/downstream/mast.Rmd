...
```{r scater_qc, results='asis'}

sca <- addPerCellQC(sca)

cat('## Detection')
plotColData(sca, y="detected", x="total")


cat('## PCA')
sca <- runPCA(sca, ncomponents=5, exprs_values='et')
plotReducedDim(sca, dimred='PCA', colour_by='general_disease')
```
