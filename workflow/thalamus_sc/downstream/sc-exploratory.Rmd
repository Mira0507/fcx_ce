...
* The _exon_type_ annotation is defined as follows:
    * _non-cryptic_:
        * the _splice_type_ is _non-cryptic_, OR
        * the _splice_type_ is cryptic, with neither the start nor end coordinates of 
          the junctions falling into intronic regions.
    * _cryptic_: the junction does not meet the criteria for _non-cryptic_ in the _exon_type_ 
      definition.
...
```{r annotate_junctions, results='asis'}
...
# exons are generated when either donor or acceptor site of junctions fall into
# intronic regions.
