...
set.seed(1772)
# use_python("../../../lcenv/bin/python", required=TRUE)
# use_condaenv('../../../lcenv', required=TRUE)
...
```{python run_ds_analysis, eval=FALSE}
...
groupfile2="results/junction_counts/celltype_groups.txt"
