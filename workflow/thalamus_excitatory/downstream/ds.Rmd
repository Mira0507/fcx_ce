...
if (! dir.exists(annocode_dir)) { dir.create(annocode_dir, recursive=TRUE) }
annocode_path <- paste0(annocode_dir, "/annotation")
...
annotation_files =[
    ...
    "_fiveprime.bed.gz",
    "_threeprime.bed.gz"]
annotation_files = [f"{r.annocode_path}/{f}" for f in annotation_files]
